...
public class WBS_3c {
	...
	public void update(int PedalPos, boolean AutoBrake, boolean Skid) {
		...
		WBS_Node_WBS_BSCU_Command_Is_Normal_Relational_Operator = change(WBS_Node_WBS_BSCU_SystemModeSelCmd_Unit_Delay == 0, false);
		...
		if (change(AutoBrake && WBS_Node_WBS_BSCU_Command_Is_Normal_Relational_Operator, AutoBrake)) {
		...
		if (change(WBS_Node_WBS_BSCU_Switch3 == 0, false)) {
		...
		if (WBS_Node_WBS_BSCU_SystemModeSelCmd_Logical_Operator6) {
			...
			if (change((WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 0)
					&& (WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 1), WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 1)) {
				WBS_Node_WBS_BSCU_Switch2 = 0;
			} else {
		...
		if (change(WBS_Node_WBS_BSCU_Command_PedalCommand_Switch1 == 0, false)) {
			Alt_Pressure = 0;
		} else {
