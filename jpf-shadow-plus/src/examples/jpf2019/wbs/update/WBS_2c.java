...
public class WBS_2c {
	...
	public void update(int PedalPos, boolean AutoBrake, boolean Skid) {
		...
		if (change(AutoBrake && WBS_Node_WBS_BSCU_Command_Is_Normal_Relational_Operator, false)) {
		...
		if (change(WBS_Node_WBS_BSCU_SystemModeSelCmd_Logical_Operator6, true)) {
		...
		if (WBS_Node_WBS_BSCU_SystemModeSelCmd_Logical_Operator6) {
			...
			if (change((WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 0)
					&& (WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch < 1), WBS_Node_WBS_BSCU_Command_AntiSkidCommand_Normal_Switch >= 0)) {
				WBS_Node_WBS_BSCU_Switch2 = 0;
			} else {
