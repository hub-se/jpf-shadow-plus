...
/*
* The original implementation of this class belongs to the jpf-symbc project. 
...
public class PCChoiceGenerator extends IntIntervalGenerator {
	...
	//probably added this as the execution mode is not restored upon backtracking in the threadinfo
