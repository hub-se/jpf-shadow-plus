...
public class BytecodeUtils {
	...
	//TODO: what happens if a different symbolic method is called that uses the same variable names?
...
//			}
  ...
  public static void clearSymVarCounter() {
	...
	public static void addConcreteValues(PathCondition pc){
		...
		for(String var : valueMap.keySet()){
			...
			if(value instanceof Integer){
				...
				//System.out.println("Added concrete condition: "+sym_v.toString()+"="+v);
	...
	/* Return whether an If-insn is executed in order to compute one of the parameters
	 * of a change(boolean,boolean) invocation.
	 */
	...
	//Executing any of these methods will reset the execution mode to BOTH
	public static HashSet<Instruction> resetInstructions = new HashSet<Instruction>();
	
	//Same as getIfExecutionMode, but with support for change(boolean,boolean) statements over multiple lines
	//BUT: Here we assume that at least part of the first parameter is on the same line as the change()-stmt
	//TODO: There must be a better way to solve this.
